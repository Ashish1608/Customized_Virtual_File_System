...
UFDT UFDTArr[MAXINODE];                         // global variable of type UFDT
...
void man(char *name)
{
    ...
    {
        printf("Description : Used to list information of all files in the directory.\n");
        printf("Usage : ls\n");
    }
...
void DisplayHelp()
{
    printf("ls : To list out all files in the current directory\n");
